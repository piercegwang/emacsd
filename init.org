...
Sometimes, if there's an error refreshing packages, you just need to re-run this code segment.
...
Can add a few seconds to startup time, may want to check "Startup Speed" on this page: [[https://github.com/rolandwalker/unicode-fonts/tree/e3942fe40b418bfb2dc4e73633e09195437fef01#customization][unicode fonts github]]
  ...
  (use-package org-roam
      ...
      (setq org-roam-directory "~/Dropbox/org-roam/"
            ...
            '(("j" "Journal" entry
               ...
               :head "#+setupfile: ~/.emacs.d/org-mode/templates/school/name_email.org
  ,#+setupfile: ~/.emacs.d/org-mode/templates/general/web.org
  ,#+roam_tags: 
  ,#+category: 
  ,#+title: [%<%Y-%m-%d %a>]\n\n")
...
#+begin_src emacs-lisp
  ...
  ("Stj" "OCS15 - T/Th" entry
   ...
   "* NEXT %?
  DEADLINE: %^{Deadline}T\n")
  ("Stm" "UM53A - T/Th" entry
   (file+headline "~/Dropbox/org/school.org" "_UM53A_")
   "**** NEXT %?
  DEADLINE: %^{Deadline}T\n")
  ("Sts" "OPS10 - M/W" entry
  ...
  DEADLINE: %^{Deadline}T\n")
  ("Stp" "OP053 - M/W" entry
   (file+headline "~/Dropbox/org/school.org" "_OP053_")
   "* NEXT %?
  DEADLINE: %^{Deadline}T\n")
  ("Stc" "OCRA1 - M/W" entry
  ...
  ")
  ("s" "Stuff")
  ("si" "Inbox" entry (file "/Users/piercewang/Dropbox/org/notes/stuff_and_things/organizing_temp.org")
   "* DECIDE %?
  %U
  ")))
...
#+begin_src emacs-lisp
  ...
  (define-key tetris-mode-map (kbd "k") 'tetris-move-bottom)
...
#+begin_src emacs-lisp
  ...
  (setq desktop-dirname "~/.emacs.d/desktopsave/")
