...
"
  ("n" (dired-quick-sort "" nil nil nil)
       (dired-quick-sort--sort-by-last ""))
  ("t" (dired-quick-sort "-t" nil nil nil)
       (dired-quick-sort--sort-by-last "-t"))
  ("s" (dired-quick-sort "-S" nil nil nil)
       (dired-quick-sort--sort-by-last "-S"))
  ("v" (dired-quick-sort "-v" nil nil nil)
       (dired-quick-sort--sort-by-last "-v"))
  ("e" (dired-quick-sort "-X" nil nil nil)
       (if (string= dired-quick-sort-sort-by-last "-X") "[X]" "[ ]"))
