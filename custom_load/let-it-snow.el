...
;; NOTE: BE SURE TO PRESERVE WHITESPACE IN THIS FILE.  SPECIFICALLY,
;; THE `snow-background` STRING MUST HAVE ALL OF ITS WHITESPACE
;; PRESERVED, OR THE TEXT-PROPERTIES WILL NOT BE READ CORRECTLY, WHICH
;; WILL CAUSE AN ERROR UPON LOAD.
