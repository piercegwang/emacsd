(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (python-docstring markdown-mode epa-file framemove treemacs-magit treemacs-evil treemacs doom-themes org-bullets org htmlize lua-mode helm magit elpy exec-path-from-shell smart-mode-line latex auctex evil-visual-mark-mode)))
 '(show-paren-mode nil)
